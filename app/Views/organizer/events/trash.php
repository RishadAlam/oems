<header class="dashboard-page-heading"><div><p class="dashboard-kicker"><i class="ph ph-archive" aria-hidden="true"></i><span>Event recovery</span></p><h1>Deleted events</h1><p>Restore eligible registration-free events to their retained lifecycle state.</p></div><a class="button button--quiet" href="/organizer/events"><i class="ph ph-arrow-left" aria-hidden="true"></i><span>Event list</span></a></header>
