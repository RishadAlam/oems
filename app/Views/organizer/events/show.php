...
<div class="organizer-detail-grid mt-8">
    ...
    <aside class="dashboard-panel organizer-actions-panel" aria-labelledby="event-actions-heading">
        ...
        <div class="organizer-action-stack">
            <?php if ($canSubmit): ?><form action="/organizer/events/<?= e($event['id']) ?>/submit" method="post" data-form-kind="action"><input type="hidden" name="_token" value="<?= e($csrfToken) ?>"><button class="button button--primary w-full" type="submit" data-submit-label="Submitting for review…"><i class="ph ph-paper-plane-tilt" aria-hidden="true"></i><span data-submit-text>Submit for review</span></button></form><?php endif; ?>
