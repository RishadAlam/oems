...
<div class="organizer-detail-grid mt-8">
    <section class="dashboard-panel" aria-labelledby="manual-check-in-heading">
        ...
        <form class="form-stack mt-6" action="/organizer/events/<?= e($eventId) ?>/check-in" method="post" data-check-in-form novalidate>
            <input type="hidden" name="_token" value="<?= e($csrfToken) ?>">
            <label class="form-field" for="ticket-code"><span>Ticket number or QR value</span><input id="ticket-code" name="code" type="text" minlength="9" maxlength="300" autocomplete="off" autocapitalize="characters" spellcheck="false" aria-describedby="ticket-code-help" required><small id="ticket-code-help">Enter the printed OEMS ticket number, or use the camera to read its QR code.</small></label>
            <button class="button button--primary" type="submit"><i class="ph ph-check-circle" aria-hidden="true"></i><span>Check in participant</span></button>
        </form>
    </section>
