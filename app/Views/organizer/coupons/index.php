...
<section class="dashboard-panel mt-8" aria-labelledby="coupon-list-heading">
    ...
    <?php else: ?>
        <div class="organizer-table-wrap mt-6"><table class="operations-table organizer-table"><caption class="sr-only">Organizer coupons</caption><thead><tr><th scope="col">Code</th><th scope="col">Scope</th><th scope="col">Discount</th><th scope="col">Usage</th><th scope="col">Status</th><th scope="col">Actions</th></tr></thead><tbody>
        <?php foreach ($coupons as $coupon): ?>
            <tr>
                <td class="organizer-table__value" data-label="Code"><strong><?= e($coupon['code']) ?></strong></td>
                <td class="organizer-table__value" data-label="Scope"><?= e($coupon['event_title'] ?? 'All owned events') ?></td>
