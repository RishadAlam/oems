...
$paymentDetailLabel = $eventCancelled
    ? 'Event cancelled'
    : ($paymentStatus === 'pending' ? 'Payment review pending' : oems_status_label($paymentStatus));
?>
...
<div class="mt-8 grid gap-6 lg:grid-cols-2">
    <section class="dashboard-panel" aria-labelledby="registration-status-heading">
        ...
        <dl class="status-list mt-5">
            <div><dt>Status</dt><dd><span class="status-chip status-chip--<?= e(status_modifier($registrationStatus, 'registration')) ?>"><?= e(oems_status_label($registrationStatus)) ?></span></dd></div>
    ...
    <section class="money-summary dashboard-panel" aria-labelledby="payment-status-heading">
        ...
        <dl class="status-list mt-5">
            ...
            <div><dt>Payment</dt><dd><span class="status-chip status-chip--<?= e(status_modifier($eventCancelled ? 'danger' : $paymentStatus, $eventCancelled ? 'tone' : 'payment')) ?>"><?= e($paymentDetailLabel) ?></span></dd></div>
