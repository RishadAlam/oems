...
<section class="dashboard-panel mt-8">
    <dl class="grid gap-4 sm:grid-cols-2"><div><dt>Status</dt><dd><span class="status-chip status-chip--<?= e(status_modifier($message['status'], 'contact')) ?>"><?= e(ucfirst($message['status'])) ?></span></dd></div><div><dt>Received</dt><dd><?= e($message['created_at']) ?></dd></div></dl>
