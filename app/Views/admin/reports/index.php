...
<section class="dashboard-panel organizer-list-panel mt-6" aria-labelledby="report-preview"><div class="dashboard-panel__heading"><span class="dashboard-panel__icon"><i class="ph ph-table" aria-hidden="true"></i></span><div><h2 id="report-preview"><?= e($reportTypes[$reportType] ?? 'Report') ?> preview</h2><p>The preview shows the first 100 aggregate rows. CSV export streams all matching rows.</p></div></div>
