    ...
    <?php else: ?>
        <div class="organizer-table-wrap">
            <table class="organizer-table">
                ...
                <thead><tr><th scope="col">Category</th><th scope="col">Slug</th><th scope="col">Order</th><th scope="col">Status</th><th scope="col"><span class="sr-only">Actions</span></th></tr></thead>
                <tbody>
