    ...
    <aside class="dashboard-panel organizer-actions-panel" aria-labelledby="moderation-actions-heading">
        ...
        <div class="organizer-action-stack">
            <?php if ($status === 'pending'): ?>
                <form action="/admin/events/<?= e($event['id']) ?>/approve" method="post"><input type="hidden" name="_token" value="<?= e($csrfToken) ?>"><button class="button button--primary w-full" type="submit"><i class="ph ph-check-circle" aria-hidden="true"></i><span>Approve event</span></button></form>
                <form class="admin-rejection-form" action="/admin/events/<?= e($event['id']) ?>/reject" method="post">
                    ...
                    <button class="button button--danger w-full" type="submit"><i class="ph ph-x-circle" aria-hidden="true"></i><span>Reject event</span></button>
                </form>
            <?php endif; ?>
