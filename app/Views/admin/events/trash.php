<header class="dashboard-page-header"><div><p class="dashboard-kicker"><i class="ph ph-archive" aria-hidden="true"></i><span>Platform recovery</span></p><h1>Deleted events</h1><p>Review deleted event history and restore only lifecycle-safe, registration-free records.</p></div><a class="button button--quiet" href="/admin/events"><i class="ph ph-arrow-left" aria-hidden="true"></i><span>Moderation queue</span></a></header>
