...
<section class="dashboard-panel mt-8" aria-labelledby="admin-trash-heading">
    ...
    <?php else: ?>
        <div class="organizer-table-wrap mt-6"><table class="operations-table organizer-table"><caption class="sr-only">Administrator deleted events</caption><thead><tr><th scope="col">Event</th><th scope="col">Organizer</th><th scope="col">Lifecycle</th><th scope="col">Deleted</th><th scope="col">Registration history</th><th scope="col">Action</th></tr></thead><tbody>
