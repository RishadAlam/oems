...
assert.equal(opened[0], 'oems-public-static-20260815-operations-table-v1');
assert.equal(JSON.stringify(opened[1]), JSON.stringify(['/offline.html', '/assets/css/app.css?v=20260815-operations-table-v1', '/assets/js/theme.js?v=20260811-form-controls-fix', '/assets/js/app.js?v=20260812-form-system', '/assets/js/pwa.js?v=20260811-form-controls-fix', '/assets/icons/oems-192.png', '/assets/icons/oems-512.png']));
...
const staticResponse = await dispatchFetch({ method: 'GET', url: 'https://events.example.test/assets/css/app.css?v=20260815-operations-table-v1', mode: 'cors' });
assert.equal(staticResponse.ok, true);
assert.equal(put.length, 1);
assert.equal(put[0][0], '/assets/css/app.css?v=20260815-operations-table-v1');
