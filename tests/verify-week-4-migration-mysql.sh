...
OEMS_PUBLIC_API_TEST_DSN="mysql:host=$mysql_host;port=$mysql_port;dbname=$database;charset=utf8mb4" \
OEMS_PUBLIC_API_TEST_USER="$mysql_user" \
OEMS_PUBLIC_API_TEST_PASSWORD="$mysql_password" \
php tests/verify-calendar-api-mysql.php

OEMS_CERTIFICATE_TEST_DSN="mysql:host=$mysql_host;port=$mysql_port;dbname=$database;charset=utf8mb4" \
OEMS_CERTIFICATE_TEST_USER="$mysql_user" \
...
OEMS_EVENT_RECOVERY_TEST_DSN="mysql:host=$mysql_host;port=$mysql_port;dbname=$database;charset=utf8mb4" \
OEMS_EVENT_RECOVERY_TEST_USER="$mysql_user" \
OEMS_EVENT_RECOVERY_TEST_PASSWORD="$mysql_password" \
php tests/verify-event-recovery-mysql.php
