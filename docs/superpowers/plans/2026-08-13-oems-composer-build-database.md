...
- [x] **Step 1: Write a fresh-schema migration test**
...
- [x] **Step 2: Write existing-database ordering and checksum tests**
...
- [x] **Step 3: Write rollback, refresh, and seed safety tests**
...
- [x] **Step 4: Run the focused test and observe the missing-class failure**
...
- [x] **Step 5: Commit the red database contract**
...
- [x] **Step 1: Implement portable migration history and SQL execution**
...
- [x] **Step 2: Implement migrate and rollback**
...
- [x] **Step 3: Implement refresh and fake-data seed**
...
- [x] **Step 4: Add the ordered migration manifest**
...
- [x] **Step 5: Add the safe CLI entry point and Composer aliases**
...
- [x] **Step 6: Run focused tests and command discovery**
...
- [x] **Step 7: Commit the database implementation**
...
- [x] **Step 1: Write a real ZIP regression test**
...
- [x] **Step 2: Run the focused test and observe the missing-class failure**
...
- [x] **Step 3: Commit the red package contract**
...
- [x] **Step 4: Implement an allowlisted atomic archive builder**
...
- [x] **Step 5: Add the package CLI and Composer alias**
...
- [x] **Step 6: Run focused tests and commit the package implementation**
...
- [x] **Step 1: Write a Composer command registration test**
...
- [x] **Step 2: Run the test and observe `build` is missing**

Run: `rtk php tests/run.php ComposerCommandTest`

Expected: failure because `build` has not been registered.

- [x] **Step 3: Commit the red Composer command contract**
...
- [x] **Step 4: Register the production build pipeline**
...
- [x] **Step 5: Document local, cPanel, and database usage**
...
- [x] **Step 6: Verify registration and commit the build/docs step**
...
- [x] **Step 1: Run database and package focused suites**
...
- [x] **Step 5: Commit any deterministic generated source changes**
